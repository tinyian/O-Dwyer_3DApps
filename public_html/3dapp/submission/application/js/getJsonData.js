...
$(document).ready(function(){
    ...
    $.getJSON('../submission/application/model/data.json', function(jsonObj){
        //index
            //home page
            ...
            camera = jsonObj.pageTextData[8];
            render = jsonObj.pageTextData[9];
        ...
        //gallery text
        $('#galleryTitle').html('<h4>' + gallery.galleryTitle + '</h4>');
        $('#galleryDescription').html('<p>' + gallery.galleryDescription + '</p>');
        
        //camera interactivity
        $('#CameraSubtitles').html('<p>' + camera.CameraSubtitles + '</p>');
        
        //render interactivity
        $('#RenderSubtitles').html('<p>' + render.RenderSubtitles + '</p>');
    });
});
